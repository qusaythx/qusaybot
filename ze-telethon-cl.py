...
try:
    ...
    api_id = '21733413'
    api_hash = 'febb4548779f2589c775b0ab870b53c6'
    bot_token = '6571138609:AAFvmJ_nWciBv5eqLkY_KSdgF_2NVpPcudw'
    DEVLOO = '6215221684'
    MAX_ACCOUNTS = int('100')
    user_bot = 'Bbjjhghbdsbot'
    id_bot = int('6571138609')
